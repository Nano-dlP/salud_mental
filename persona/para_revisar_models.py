...
from core.models import Auditoria, Tipo_Documento, Genero,Nivel_Educativo, Localidad
...
class Persona(Auditoria):
    ...
    genero = models.ForeignKey(Genero, verbose_name=("Género"), on_delete=models.CASCADE, related_name='persona_genero')
    ...
    direccion_numero = models.CharField(max_length=10, verbose_name=("Número de dirección"), blank=True, null=True)
    direccion_piso = models.CharField(max_length=10, verbose_name=("Piso"), blank=True, null=True)
    direccion_depto = models.CharField(max_length=10, verbose_name=("Departamento"), blank=True, null=True)
    localidad = models.ForeignKey(Localidad, verbose_name=("Localidad"), on_delete=models.CASCADE, related_name='persona_localidad', blank=True, null=True)
    ciudad_nacimiento = models.CharField(max_length=100, verbose_name=("Ciudad de nacimiento"), blank=True, null=True)
    nivel_educativo = models.ForeignKey(Nivel_Educativo, verbose_name=("Nivel educativo"), on_delete=models.CASCADE, related_name='persona_nivel_educativo')
    ocupacion = models.CharField(max_length=100, verbose_name=("Ocupación"), blank=True, null=True)
    posee_cobertura_salud = models.BooleanField(default=False, verbose_name=("Posee cobertura de salud?"))
    cobertura_salud = models.CharField(max_length=100, verbose_name=("Cobertura de salud"), blank=True, null=True)
    posee_grupo_apoyo = models.BooleanField(default=False, verbose_name=("Posee grupo de apoyo?"))
